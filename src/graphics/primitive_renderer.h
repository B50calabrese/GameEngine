...
class PrimitiveRenderer {
 public:
   ...
   */
  static void start_batch(const glm::mat4& view_projection);
   ...
   */
  static void submit_quad(const glm::vec2& position, const glm::vec2& size,
   ...
   */
  static void submit_textured_quad(const glm::vec2& position,
                                   const glm::vec2& size,
