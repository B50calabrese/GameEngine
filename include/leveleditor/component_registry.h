...
class ComponentRegistry {
 public:
  struct ComponentInfo {
    ...
    std::function<void(engine::ecs::EntityID, engine::ecs::Registry&, nlohmann::json&)> serialize_func;
    std::function<void(engine::ecs::EntityID, engine::ecs::Registry&, const nlohmann::json&)> deserialize_func;
    std::function<void(engine::ecs::EntityID, engine::ecs::Registry&)> add_func;
    std::function<void(engine::ecs::EntityID, engine::ecs::Registry&)> remove_func;
  ...
  const std::map<std::string, ComponentInfo>& GetComponents() const { return components_; }
