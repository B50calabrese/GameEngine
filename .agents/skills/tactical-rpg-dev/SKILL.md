...
2. Update `ClassTypeToString` in `demos/games/tactical-rpg/game_types.h`.
3. Create a new registration file: `demos/games/tactical-rpg/classes/<your_class>.cpp`.
...
1. Define the action data in `demos/games/tactical-rpg/action_registry.cpp` within `RegisterAll()`.
