...
class SceneBOverlay : public engine::Scene {
 public:
  ...
  void OnRender() override {
    ...
    engine::graphics::Renderer::Get().DrawRect(-0.5f, -0.5f, 1.0f, 1.0f, 0.0f,
                                               1.0f, 0.0f);
  }
...
class SceneB : public engine::Scene {
 public:
  ...
  void OnRender() override {
    ...
    engine::graphics::Renderer::Get().DrawRect(-1.0f, -1.0f, 2.0f, 2.0f, 0.0f,
                                               0.0f, 1.0f);
  }
...
class SceneA : public engine::Scene {
 public:
  ...
  void OnRender() override {
    ...
    engine::graphics::Renderer::Get().DrawRect(-1.0f, -1.0f, 2.0f, 2.0f, 1.0f,
                                               0.0f, 0.0f);
  }
