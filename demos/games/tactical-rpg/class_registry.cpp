...
void ClassRegistry::RegisterAll() {
  // Barbarian
  {
    ...
    def.base_actions.push_back({"Greataxe",
                                ...
                                false,
                                "Heavy axe swing.",
                                {std::make_shared<DamageEffect>(12, 1, 3)}});
    def.base_actions.push_back(
        {"Rage", ActionType::Ability, 0, true, "Enter rage.", {}});
    RegisterClass(def);
  }
  ...
  // Fighter
  {
    ...
    def.base_actions.push_back({"Longsword",
                                ...
                                {std::make_shared<DamageEffect>(10, 1, 3)}});
    def.base_actions.push_back({"Second Wind",
                                ActionType::Ability,
                                0,
                                true,
                                "Self heal.",
                                {std::make_shared<HealEffect>(10, 1, 2)}});
    RegisterClass(def);
  }
  ...
  // Rogue
  {
    ...
    def.base_actions.push_back({"Shortsword",
                                ...
                                {std::make_shared<DamageEffect>(6, 1, 3)}});
  ...
  // Wizard
  {
    ...
    def.base_actions.push_back({"Dagger",
                                ...
                                false,
                                "Small blade strike.",
                                {std::make_shared<DamageEffect>(4, 1, 1)}});
    def.base_actions.push_back({"Firebolt",
                                ActionType::Spell,
                                24,
                                false,
                                "Hurl fire.",
                                {std::make_shared<DamageEffect>(10, 1, 0)}});
    RegisterClass(def);
  }
  ...
  // Cleric
  {
    ...
    def.base_actions.push_back({"Mace",
                                ...
                                false,
                                "Blunt strike.",
                                {std::make_shared<DamageEffect>(6, 1, 2)}});
    def.base_actions.push_back({"Sacred Flame",
                                ActionType::Spell,
                                12,
                                false,
                                "Divine fire.",
                                {std::make_shared<DamageEffect>(8, 1, 0)}});
    RegisterClass(def);
  }
  ...
  // Bard
  {
    ...
    def.base_actions.push_back({"Rapier",
                                ...
                                false,
                                "Elegant strike.",
                                {std::make_shared<DamageEffect>(8, 1, 2)}});
    def.base_actions.push_back({"Vicious Mockery",
                                ActionType::Spell,
                                12,
                                false,
                                "Harmful insult.",
                                {std::make_shared<DamageEffect>(4, 1, 0)}});
    RegisterClass(def);
  }
  ...
  // Druid
  {
    ...
    def.base_actions.push_back({"Quarterstaff",
                                ...
                                false,
                                "Wooden strike.",
                                {std::make_shared<DamageEffect>(6, 1, 0)}});
  ...
  // Monk
  {
    ...
    def.base_actions.push_back({"Unarmed",
                                ...
                                false,
                                "Bare hands.",
                                {std::make_shared<DamageEffect>(8, 1, 3)}});
    def.base_actions.push_back({"Martial Arts",
                                ActionType::Attack,
                                1,
                                true,
                                "Quick kick.",
                                {std::make_shared<DamageEffect>(4, 1, 3)}});
    RegisterClass(def);
  }
  ...
  // Paladin
  {
    ...
    def.base_actions.push_back({"Lay on Hands",
                                ...
                                false,
                                "Heal touch.",
                                {std::make_shared<HealEffect>(0, 0, 5)}});
    RegisterClass(def);
  }
